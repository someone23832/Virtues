...
SMODS.Joker{
  ...
  loc_txt = {
    ...
    text = {
			...
			"{C:spades}Spade{} card in hand at end of round",
			"{C:attention}Destroyed{} upon scoring a {C:spades}Spade",
...
SMODS.Joker{
  ...
  loc_txt = {
    ...
    text = {
			...
			"{C:hearts}Heart{} card in hand at end of round",
			"{C:attention}Destroyed{} upon scoring a {C:Hearts}Heart",
...
SMODS.Joker{
  ...
  loc_txt = {
    ...
    text = {
			...
			"{C:clubs}Club{} card in hand at end of round",
			"{C:attention}Destroyed{} upon scoring a {C:clubs}Club",
...
SMODS.Joker{
  ...
  loc_txt = {
    name = 'Restraint',
    text = {
      "{C:attention}Boss Blind{} payout increases",
      "by {C:money}$#1#{} for each {C:diamonds}Diamond{}",
      "card in hand at end of round",
      "{C:attention}Destroyed{} upon scoring a {C:diamonds}Diamond{}",
      "{C:inactive}(Currently {C:money}+$#2#{C:inactive})"
    }
  },
  config = {extra = {money_add = 1, money = 1, broken = false}},
...
-- Just has to exist in joker slots, card:is_suit() lovely patchh does the work.
SMODS.Joker{
  key = 'carousel',
  loc_txt = {
    name = 'Carousel',
    text = {
      "{C:spades}Spades{} count as {C:hearts}Hearts{}",
      "{C:hearts}Hearts{} count as {C:clubs}Clubs{}",
      "{C:clubs}Clubs{} count as {C:diamonds}Diamonds{}",
      "{C:diamonds}Diamonds{} count as {C:spades}Spades{}"
    }
  },
...
SMODS.Joker{
  ...
  config = {extra = {chips_add = 6, chips = 0}},
...
SMODS.Joker{
  ...
  config = {extra = {Xmult_add = 0.05, Xmult = 1}},
  yes_pool_flag = "fallen",
  rarity = 1,
  atlas = 'virtues',
  pos = {x = 1, y = 1},
...
SMODS.Joker{
  ...
  config = {extra = {money = 10, chips = 6, mult = 2, moneygain = 1, moneyend = 0}},
  yes_pool_flag = "fallen",
  rarity = 1,
  atlas = 'virtues',
  pos = {x = 3, y = 1},
